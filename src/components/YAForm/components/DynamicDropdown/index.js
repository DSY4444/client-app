...
const DynamicDropdown = (props) => {
    const { watch, destinationTable, setDestinationTable, setValue, control, disabled, formId, fieldDef: { name, displayName, required, variant, width, placeholder, dataSource, toolTip }, errorMessage } = props;
        ...
        <Controller
            ...
            render={({ field: { onChange, value } }) => {
                return <Autocomplete
                    ...
                    disabled={loading}
                    options={name === 'toAsset' ? options.filter( option => option.name !== destinationTable) : options}
                    value={value}
                    // inputValue={value}
                    ...
                    getOptionLabel={option => {
                        ...
                        return isExisting ? option?.label : `Add "${option?.label}"`
                    }}
                    renderInput={params => 
                        <>
