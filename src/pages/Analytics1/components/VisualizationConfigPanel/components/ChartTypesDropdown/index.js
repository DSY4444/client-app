        ...
        <MDBox>
            ...
            >
                <MDBox className="selectionBox">
                    ...
                    <MDTypography data-testid = {selectedChartType?.title?.toLowerCase().replaceAll(' ', '')} className="subtitle" variant="button" color="text">{selectedChartType?.title}</MDTypography>
                </MDBox>
